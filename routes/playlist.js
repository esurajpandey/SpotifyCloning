...
const uploadImage = require("../Admin/Handler/multerImage");
...
route.post('/edit',authenticateToken,uploadImage.single("cover"),playlist.editPlaylist);
...
route.get('/userPlaylists/:offset',authenticateToken,playlist.getUserPlaylist);
